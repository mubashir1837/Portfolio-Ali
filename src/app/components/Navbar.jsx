            ...
            <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
              ...
              <div className="hidden sm:ml-6 sm:block">
                <div className="flex space-x-4">
                  <a href="#home" className="rounded-md bg-gray-950 px-3 py-2 text-sm font-medium text-white" aria-current="page">Home</a>
                  <a href="#about" className="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-blue-950 hover:text-white">About</a>
                  <a href="#experience" className="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-blue-950 hover:text-white">Experience</a>
                  <a href="#skills" className="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-blue-950 hover:text-white">Skills</a>
                  <a href="#education" className="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-blue-950 hover:text-white">Education</a>
                  <a href="#projects" className="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-blue-950 hover:text-white">Projects</a>
                  <a href="#contact" className="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-blue-950 hover:text-white">Contact</a>
                </div>
              </div>
            </div>
              ...
              <div className="relative ml-3">
                <div>
                  <button type="button" className="relative flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                    ...
                    <Image className="h-8 w-8 rounded-full border border-blue-200" src="/img.jpg" alt="Dynamic Image" width="20" height="20" />
                  </button>
                </div>
              </div>
            </div>
